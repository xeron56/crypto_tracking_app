...
import 'package:crypto_tracking_app/src/frontend/mainpage/mini_graph.dart';
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              ...
              spreadRadius: 2,
              blurRadius: 5,
              offset: Offset(0, 5), // Shadow offset adjustment
            ),
          ],
        ),
        child: Padding(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Text(
                            ...
                            style: TextStyle(
                              color:
                                  _isPositive ? Colors.blue : Color(0xFFCC6061),
                              fontSize: 16,
                              fontWeight: FontWeight.w400,
                              letterSpacing: 0.3,
                            ),
